...
* Elasticsearch
  * http://www.elasticsearch.org/downloads (currently 1.4beta1)
* Elasticsearch Mapper Attachment plugin (currently 2.4)
  * https://github.com/elasticsearch/elasticsearch-mapper-attachments/tree/master
  * from elastisearch root: `bin/plugin -install elasticsearch/elasticsearch-mapper-attachments/2.4.0`
...
* [Fog](http://fog.io/) + [Capistrano](http://capistranorb.com/)
