...
* Elasticsearch
  * http://www.elasticsearch.org/downloads (currently 1.3.4)
* Elasticsearch Mapper Attachment plugin (currently 2.3.2)
  * https://github.com/elasticsearch/elasticsearch-mapper-attachments/tree/master
  * from elastisearch root: `bin/plugin -install elasticsearch/elasticsearch-mapper-attachments/2.3.2`
