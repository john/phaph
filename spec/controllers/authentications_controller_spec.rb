  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created authentication" do
        post :create, {:authentication => valid_attributes}, valid_session
        expect(response).to redirect_to(Authentication.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved authentication as @authentication" do
        post :create, {:authentication => invalid_attributes}, valid_session
        expect(assigns(:authentication)).to be_a_new(Authentication)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested authentication" do
        authentication = Authentication.create! valid_attributes
        put :update, {:id => authentication.to_param, :authentication => new_attributes}, valid_session
      ...
      it "redirects to the authentication" do
        authentication = Authentication.create! valid_attributes
        put :update, {:id => authentication.to_param, :authentication => valid_attributes}, valid_session
        expect(response).to redirect_to(authentication)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the authentication as @authentication" do
        authentication = Authentication.create! valid_attributes
        put :update, {:id => authentication.to_param, :authentication => invalid_attributes}, valid_session
        expect(assigns(:authentication)).to eq(authentication)
      end
