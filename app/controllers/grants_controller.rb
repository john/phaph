class GrantsController < ApplicationController
  ...
  def new
    ...
    if params[:l].present?
      vals[:organization_id] = params[:l].to_i
    end
  ...
  private
    ...
    def grant_params
      params.require(:grant).permit(:name, :description, :source, :source_id, :principal_investigators, :investigators, :program_manager, :sponsor, :nsf_programs, :nsf_program_reference_code, :nsf_program_element_code, :awarded_at, :starts_at, :ends_at, :amount, :overhead, :user_id, :user_id, :organization_id, :scope, :state)
    end
end
